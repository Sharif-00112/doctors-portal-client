        ...
        <div>
            ...
            <Box style={appointmentBanner} sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid xs={12} md={6}>
                        <Typography sx={{ mb: 2, mt: 4, fontWeight: 500, color: 'success.main' }} variant="h5" component="div">
                            Appointment
                        </Typography>
                        <Typography sx={{ mb: 2, mt: 4, fontWeight: 500, color: 'success.main' }} variant="" component="div">
